# -*- coding: utf-8 -*-
"""final_results_cosine_similarity_count_vectorizer.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1wiCOaER4Lo4IqjBKO13F4eRXBguWklW7
...
def nDCG(base_hashtag, base_date, prediction_list, docs_preprocessed, u_location):
  ground_truth = get_relevant_docs_list_for_base_hashtag(base_hashtag, base_date, docs_preprocessed, u_location)
  ground_truth_scores = {}
...
def precision_at_k(k, base_hashtag, base_date, prediction_list, docs_preprocessed, u_location):
  relevant_docs_list = get_relevant_docs_list_for_base_hashtag(base_hashtag, base_date, docs_preprocessed, u_location)
...
def mean_average_precision(max_k, base_hashtag, base_date, relevant_docs, docs_preprocessed, u_location):
  average_precision=0
  ctr=0
  relevant_docs_list = get_relevant_docs_list_for_base_hashtag(base_hashtag, base_date, docs_preprocessed, u_location)
  ...
  for k_val in range(1,len(relevant_docs_list)+1):
    ...
    if k_val>len(relevant_docs_list):
      break
    precision_at_k_val = precision_at_k(k_val, base_hashtag, base_date, relevant_docs, docs_preprocessed, u_location)
...
def recall_at_k(k, base_hashtag, base_date, prediction_list, docs_preprocessed, u_location):
  relevant_docs_list = get_relevant_docs_list_for_base_hashtag(base_hashtag, base_date, docs_preprocessed, u_location)
...
def mean_average_recall(max_k, base_hashtag, base_date, relevant_docs, docs_preprocessed, u_location):
  average_recall=0
  ctr=0
  relevant_docs_list = get_relevant_docs_list_for_base_hashtag(base_hashtag, base_date, docs_preprocessed, u_location)
  print(len(relevant_docs_list))
  for k_val in range(1,len(relevant_docs_list)+1):
    ...
    if k_val>len(relevant_docs_list):
      break
    recall_at_k_val = recall_at_k(k_val, base_hashtag, base_date, relevant_docs, docs_preprocessed, u_location)
...
def find_relevant_documents_cosine_similarity_count_vectorizer(docs_preprocessed, processed_query, u_base_hashtag, u_time, u_location):
