...
for iter in tqdm(range(len(global_list))):
  ...
  # Plain
  relevant_articles_list_plain = find_relevant_documents_okapibm25(docs_preprocessed, tweet_query)
  ...
  # keyword extractor
  tweet_query_keyword_extractor = get_keyword_keywordextractor(df_query)
  relevant_articles_list_keyword_extractor = find_relevant_documents_okapibm25(docs_preprocessed, tweet_query_keyword_extractor[:20])
  ...
  relevant_articles_list_rake = find_relevant_documents_okapibm25(docs_preprocessed, tweet_query_rake)
  ...
  relevant_articles_list_yake = find_relevant_documents_okapibm25(docs_preprocessed, tweet_query_yake)
  ...
  relevant_articles_list_text_rank = find_relevant_documents_okapibm25(docs_preprocessed, tweet_query_text_rank)
  ...
  relevant_articles_list_keybert = find_relevant_documents_okapibm25(docs_preprocessed, tweet_query_keybert)
